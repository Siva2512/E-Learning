...
import { Star, PlayCircle, CheckCircle, ChevronDown, X } from "lucide-react";
        ...
        >
          ...
          >
            ...
            <div className="flex gap-3 mt-6">
              ...
              <button
                onClick={() => { setShowLoginPrompt(false); onClose(); router.push("/"); }}
              ...
              <div className="bg-white rounded-2xl shadow p-5 h-fit">
                <div className="relative rounded-xl overflow-hidden">
                  <Image src={course.image || "/Featured1.png"} alt={course.title}
                    width={400} height={250} className="w-full object-cover" />
                </div>
                <div className="mt-4">
                  {price === 0 ? (
                ...
                <div className="mt-6">
                  ...
                  <ul className="space-y-4 text-sm text-gray-600">
                    <li className="flex items-center gap-3"><FaAward        className="w-4 h-4" />Certificate of completion</li>
                    <li className="flex items-center gap-3"><FaInfinity     className="w-4 h-4" />Lifetime access</li>
                    <li className="flex items-center gap-3"><FaHeadphonesAlt className="w-4 h-4" />24/7 Premium support</li>
                    <li className="flex items-center gap-3"><FaDownload     className="w-4 h-4" />15+ Downloadable resources</li>
                    <li className="flex items-center gap-3"><FaLaptop       className="w-4 h-4" />Access on mobile and TV</li>
                  </ul>
