  ...
  const curriculum = course.curriculum || [
    {
      ...
      meta: "5 lessons · 1h 00m",
      lessons: [
        { name: "Course Overview", time: "05:00" },
        { name: "Environment Setup", time: "12:00" },
      ],
    },
    {
      title: "Core Concepts",
    ...
    },
    {
      ...
      meta: "10 lessons · 3h 00m",
      lessons: [],
    },
    {
      title: "Projects & Practice",
      meta: "6 lessons · 2h 00m",
      lessons: [],
    },
    {
      title: "Final Capstone Project",
      meta: "4 lessons · 1h 30m",
      lessons: [],
    },
  ];
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          animation:
            "slideInPanel 0.35s cubic-bezier(0.16,1,0.3,1) forwards",
        }}
      ...
      >
        ...
        <div className="bg-white px-8 pt-10 pb-6">
          ...
          <p className="text-gray-600 mt-3 max-w-2xl text-sm">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                ...
                <div className="text-gray-600 leading-relaxed space-y-4 text-sm">
                  ...
                  <p>
                    {course.fullDescription2 ||
                      "By the end, you will have the confidence to apply these skills in any professional setting."}
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow p-5 h-fit">
              ...
              <div className="mt-6">
                ...
                <ul className="space-y-4 text-sm text-gray-600">
                  ...
                  <li className="flex items-center gap-3">
                    <FaHeadphonesAlt className="w-4 h-4" />
