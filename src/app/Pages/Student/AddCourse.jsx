...
import { BookOpen, User, DollarSign, Clock, BarChart2, ImageIcon, AlignLeft, ChevronRight, CheckCircle, Lock } from "lucide-react";
...
export default function AddCourse() {
  ...
  const [course,    setCourse]    = useState({ title: "", instructor: "", price: "", hours: "", level: "", image: "", desc: "" });
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-500 mt-2 text-sm">Only admins can add courses.</p>
          <button
            onClick={() => router.back()}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div key={name} className={half ? "" : "sm:col-span-2"}>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-9 pr-4 py-2.5 text-sm border rounded-xl outline-none transition
                        ${errors[name]
            ...
            <div>
              ...
              <textarea
                ...
                value={course.desc} onChange={handleChange}
                className={`w-full px-4 py-2.5 text-sm border rounded-xl outline-none transition resize-none
                  ${errors.desc
                    ? "border-red-400 bg-red-50 focus:ring-2 focus:ring-red-200"
                    : "border-gray-200 bg-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100"
                  }`}
            ...
            {course.title && (
              <div className="bg-indigo-50 border border-indigo-100 rounded-xl p-4 flex items-center gap-4">
                ...
                <span className="text-xs bg-indigo-600 text-white px-2 py-0.5 rounded-full shrink-0">Preview</span>
              </div>
            )}
            ...
            <div className="flex items-center justify-between pt-2 border-t border-gray-100">
              ...
              <button
                type="submit"
                className="bg-indigo-600 hover:bg-indigo-700 text-white px-8 py-2.5 rounded-xl text-sm font-semibold transition shadow-sm flex items-center gap-2"
              >
